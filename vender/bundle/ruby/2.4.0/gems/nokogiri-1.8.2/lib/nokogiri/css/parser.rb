  ...
  module CSS
    class Parser < Racc::Parser
      def unescape_css_identifier(identifier)
        identifier.gsub(/\\(?:([^0-9a-fA-F])|([0-9a-fA-F]{1,6})\s?)/) { |_m| Regexp.last_match(1) || [Regexp.last_match(2).hex].pack('U') }
      end
      ...
      def _reduce_4(_val, _values, result)
        result = :DIRECT_ADJACENT_SELECTOR 
        result
      end

      def _reduce_5(_val, _values, result)
        result = :CHILD_SELECTOR 
        result
      end

      def _reduce_6(_val, _values, result)
        result = :FOLLOWING_SELECTOR 
        result
      end

      def _reduce_7(_val, _values, result)
        result = :DESCENDANT_SELECTOR 
        result
      end

      def _reduce_8(_val, _values, result)
        result = :CHILD_SELECTOR 
        result
      end
      ...
      def _reduce_62(_val, _values, result)
        result = :equal 
        result
      end

      def _reduce_63(_val, _values, result)
        result = :prefix_match 
        result
      end

      def _reduce_64(_val, _values, result)
        result = :suffix_match 
        result
      end

      def _reduce_65(_val, _values, result)
        result = :substring_match 
        result
      end

      def _reduce_66(_val, _values, result)
        result = :not_equal 
        result
      end

      def _reduce_67(_val, _values, result)
        result = :includes 
        result
      end

      def _reduce_68(_val, _values, result)
        result = :dash_match 
        result
      end
